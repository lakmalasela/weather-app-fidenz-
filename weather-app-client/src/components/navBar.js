    ...
    return (
        <nav className="navbar navbar-expand-lg">
            <div className="container-fluid">
                <button className="navbar-brand" style={{background: 'none', border: 'none', color: 'white', fontSize: '1.25rem', padding: '0', cursor: 'pointer'}}>Weather App</button>
                <div className="collapse navbar-collapse" id="navbarText">
                    <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                        <li className="nav-item">
                            {/* <button className="nav-link active" style={{background: 'none', border: 'none', color: 'white', padding: '0.5rem 1rem', cursor: 'pointer'}} onClick={handleLogout}>Log Out</button> */}
                        </li>
                    </ul>
